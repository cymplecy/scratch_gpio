...
chromium-browser --start-maximized --load-extension=S3GPIOExtension https://scratch.mit.edu/projects/285979180 "https://localhost/translate?language=fr&text=[Test]"
sudo pkill -f scratchgpio_handler
#sudo pkill -f S3GPIOServer2
