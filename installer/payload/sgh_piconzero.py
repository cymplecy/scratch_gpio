...
#sw storage list for pixel values
pixelState = [[0,0,0] for x in xrange(101)]
...
def setPixel (Pixel, Red, Green, Blue, Update=True):
    ...
    pixelState[Pixel][0] = Red
    pixelState[Pixel][1] = Green
    pixelState[Pixel][2] = Blue    
    #print "PS:",pixelState[Pixel]
    for i in range(RETRIES):
        try:
...
def getPixel (Pixel):
    return pixelState[Pixel][0] , pixelState[Pixel][1] , pixelState[Pixel][2]
