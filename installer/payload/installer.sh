...
#Version 26Jun17 add in Scratch2GPIO
...
echo "sudo pkill -f wstosgh" >> $RDIR/scratchgpio${SGHVER}/scratchgpio${SGHVER}.sh
...
echo "sudo pkill -f wstosgh" >> $RDIR/scratchgpio${SGHVER}/oldscratchgpio${SGHVER}.sh
