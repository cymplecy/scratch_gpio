...
cp $HOME/sghdev/scratch_gpio/scratchgpio_handler6.py $HOME/sghdev/scratch_gpio/installer/payload
...
cp $HOME/sghdev/scratch_gpio/cheerlights.py $HOME/sghdev/scratch_gpio/installer/payload
